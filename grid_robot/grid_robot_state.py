class grid_robot_state:
    ...
    def is_goal_state(_grid_robot_state):
        ...
        return robot_location[0] == lamp_location[0] and robot_location[1] == lamp_location[1] and _grid_robot_state.get_lamp_height() == _grid_robot_state.get_carried_stairs()
